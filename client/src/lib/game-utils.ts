...
export const WHEEL_SLICES = [
  { label: "1,000 Coins", value: 0, color: "#3b82f6" },
  { label: "2,500 Coins", value: 0, color: "#8b5cf6" },
  { label: "0.50 USDT", value: 0.50, color: "#06b6d4" },
  { label: "Energy", value: 0, color: "#10b981" },
  { label: "$5 USDT", value: 5.00, color: "#f59e0b" },
  { label: "JACKPOT!", value: 100.00, color: "#ef4444" },
  { label: "5,000 Coins", value: 0, color: "#6366f1" },
  { label: "500 Coins", value: 0, color: "#ec4899" },
] as const;
