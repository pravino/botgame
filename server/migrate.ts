...
export async function runMigrations() {
  ...
  await baselineSync(migrationPool);
  console.log("Baseline sync: all tables and columns verified");

  await markBaselineMigrationApplied(migrationPool, migrationsPath);
